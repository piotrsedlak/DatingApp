...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        this.alertify.error('Denied Acess');
...
var MemberDetailResolver = /** @class */ (function () {
    ...
    MemberDetailResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUser(route.params['id']).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            _this.alertify.error('Problem retrieveing data');
...
/***/ "./src/app/_services/error.intercepter.ts":
/*!************************************************!*\
  !*** ./src/app/_services/error.intercepter.ts ***!
  \************************************************/
...
/* harmony import */ var _services_error_intercepter__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./_services/error.intercepter */ "./src/app/_services/error.intercepter.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(_routes__WEBPACK_IMPORTED_MODULE_20__["appRoutes"]),
            ...
            providers: [
                ...
                _services_error_intercepter__WEBPACK_IMPORTED_MODULE_15__["ErrorInterceptorProvider"],
...
var MemberEditComponent = /** @class */ (function () {
    ...
    MemberEditComponent.prototype.updateUser = function () {
        ...
        this.userService.updateUser(this.authService.decodedToken.nameid, this.user).subscribe(function (next) {
            ...
            return _this.alertify.error(error);
        });
    };
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_5__["AlertifyService"]])
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        var _this = this;
        this.alertify.confirm('Do you want to delete the message?', function () {
    ...
    MessagesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"],
            _services_alertify_service__WEBPACK_IMPORTED_MODULE_2__["AlertifyService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])
    ], MessagesComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Peter\source\repos\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
